...
Column=["Date","Rate(%)","Rate(%)","Normalized Casses","Normalized Casses","Normalized Casses"...
    ,"Normalized Casses","Normalized Casses"];
...
xlabel('Time(dayes)')
% title(Name(H));
save new_deth.mat XTest YPred_Test
